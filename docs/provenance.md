...
| `vanilla_base.json`, dynamic star EMC mapping, and compact tooltip notation | ProjectE `PECustomConversionProvider`; ProjectExpansion `EMCFormat` and generated star recipes | ProjectE `15d4ce65bd06eb4222709b984255fbf5080e78bc`; ProjectExpansion `168bcf2491b9fde679295fd412ad9c93fd3d93f1` | MIT | Vanilla seed values, suffix vocabulary, and star progression researched; arbitrary-precision formatter, Fabric recipe adapter, coverage gate, and tests are original ProjectEX code |
