...
| System, naming, and visual lineage | Equivalent Exchange 2 by x3n0ph0b3 | Historical reference; [Tekkit Classic EE2 page](https://tekkitclassic.fandom.com/wiki/Equivalent_Exchange_2) | No material redistributed | Historical attribution only; ProjectEX bundles no EE2 code, binary, texture, model, sound, or other asset |
...
| `vanilla_base.json`, version EMC seeds, dynamic star EMC mapping, and compact tooltip notation | [Tekkit Classic EMC catalog](https://tekkitclassic.fandom.com/wiki/EMC); ProjectE `PECustomConversionProvider`; ProjectExpansion `EMCFormat` and generated star recipes | Tekkit page retrieved 2026-07-20; ProjectE `15d4ce65bd06eb4222709b984255fbf5080e78bc` and current-catalog audit `15d4ce65bd06eb4222709b984255fbf5080e78bc`; ProjectExpansion `168bcf2491b9fde679295fd412ad9c93fd3d93f1` | Fandom CC BY-SA page / upstream MIT code | Numeric compatibility research and attribution; primitive/uncraftable seeds are explicit, crafted items are calculated by original ProjectEX recipe mapping code |
